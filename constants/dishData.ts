...
// [Updated] 4지 선다형 질문 리스트 (한국어)
export const QUESTIONS = [
  // STEP 1. Base (Melody vs Story)
  {
    id: 1,
    category: 'STEP 01. Select Base',
    query: "음악의 '첫인상'을 결정하는 것은 무엇인가요?",
    options: [
      { icon: "🎵", text: "중독적인 멜로디", subtext: "가사는 잘 몰라도 하루 종일 흥얼거리게 되는 멜로디.", value: 'S' },
      { icon: "🎹", text: "비트와 도입부", subtext: "듣자마자 꽂히는 사운드와 비트. 가사는 그 다음.", value: 'S' },
      { icon: "📖", text: "공감되는 가사", subtext: "내 이야기처럼 마음에 와닿는 가사가 들릴 때.", value: 'B' },
      { icon: "🎤", text: "가수의 목소리", subtext: "가수의 음색과 감정 표현이 가장 중요.", value: 'B' }
    ]
  },
  // STEP 2. Intensity (Mild vs Spicy)
  {
    ...
    query: "지금 어떤 에너지가 필요하신가요?",
    options: [
      { icon: "☁️", text: "편안한 힐링", subtext: "스트레스를 풀어주고 마음을 차분하게 해주는 음악.", value: 'C' },
      { icon: "☕", text: "집중과 몰입", subtext: "일이나 공부할 때 방해되지 않는 배경음악.", value: 'C' },
      { icon: "🔥", text: "운동과 드라이브", subtext: "심장을 뛰게 하고 아드레날린을 높여주는 음악.", value: 'D' },
      { icon: "🎉", text: "신나는 파티", subtext: "미친 듯이 뛰어놀 수 있는 폭발적인 에너지.", value: 'D' }
    ]
  },
  // STEP 3. Texture (Organic vs Processed)
  {
    ...
    query: "어떤 사운드 질감을 선호하시나요?",
    options: [
      { icon: "🌿", text: "담백한 어쿠스틱", subtext: "기계음 없는 통기타나 피아노 본연의 소리.", value: 'O' },
      { icon: "🥁", text: "리얼 편곡", subtext: "콘서트장에 온 듯한 드럼과 베이스의 리얼 사운드.", value: 'O' },
      { icon: "✨", text: "몽환적인 신스", subtext: "안개처럼 퍼지는 부드러운 신디사이저 소리.", value: 'P' },
      { icon: "🤖", text: "세련된 전자음", subtext: "딱딱 떨어지는 정교하고 쿨한 기계음.", value: 'P' }
    ]
  },
  // STEP 4. Garnish (Famous vs Hidden)
  {
    ...
    query: "새로운 음악을 주로 어떻게 찾으시나요?",
    options: [
      { icon: "🏆", text: "인기 차트", subtext: "남들이 많이 듣는 검증된 Top 100 곡이 좋다.", value: 'F' },
      { icon: "📱", text: "소셜 미디어 트렌드", subtext: "릴스, 틱톡, 쇼츠 등에서 유행하는 노래.", value: 'F' },
      { icon: "⛏️", text: "디깅과 탐험", subtext: "관련 아티스트를 파고들며 숨은 명곡을 찾는다.", value: 'H' },
      { icon: "💿", text: "숨겨진 수록곡", subtext: "타이틀곡보다 앨범 속 나만의 취향저격 곡을 선호.", value: 'H' }
    ]
  }
];

// [Updated] 4지 선다형 질문 리스트 (English)
export const QUESTIONS_EN = [
  // STEP 1. Base (Melody vs Story)
  {
    ...
    options: [
      { icon: "🎵", text: "Addictive Melody", subtext: "I hum the tune all day, even if I don't know the lyrics.", value: 'S' },
      { icon: "🎹", text: "Instrumental & Beat", subtext: "The sound intro hooks me immediately. Lyrics come second.", value: 'S' },
      { icon: "📖", text: "Relatable Lyrics", subtext: "I listen when the lyrics feel like my own story.", value: 'B' },
      { icon: "🎤", text: "Artist's Voice & Emotion", subtext: "The tone and emotional delivery matter most.", value: 'B' }
    ]
  },
  // STEP 2. Intensity (Mild vs Spicy)
  {
    ...
    options: [
      { icon: "☁️", text: "Deep Sleep & Relax", subtext: "Calm music to relieve stress and drift away.", value: 'C' },
      { icon: "☕", text: "Focus & Concentration", subtext: "Stable background music for working or studying.", value: 'C' },
      { icon: "🔥", text: "Workout & Drive", subtext: "Pumping beats to boost my adrenaline.", value: 'D' },
      { icon: "🎉", text: "Party & Hype", subtext: "Explosive energy to go crazy and have fun.", value: 'D' }
    ]
  },
  // STEP 3. Texture (Organic vs Processed)
  {
    ...
    options: [
      { icon: "🌿", text: "Raw Acoustic", subtext: "Unplugged guitar or piano sounds without effects.", value: 'O' },
      { icon: "🥁", text: "Live Band Sound", subtext: "Realistic drums and bass like a live concert.", value: 'O' },
      { icon: "✨", text: "Dreamy Synthesizer", subtext: "Soft, misty, and atmospheric digital sounds.", value: 'P' },
      { icon: "🤖", text: "Futuristic Electronic", subtext: "Precise, glitchy, and cool mechanical sounds.", value: 'P' }
    ]
  },
  // STEP 4. Garnish (Famous vs Hidden)
  {
    ...
    options: [
      { icon: "🏆", text: "Top 100 Charts", subtext: "I trust what everyone else is listening to.", value: 'F' },
      { icon: "📱", text: "Trending on Social Media", subtext: "Songs I heard on Reels, TikTok, or Shorts.", value: 'F' },
      { icon: "⛏️", text: "Digging & Exploring", subtext: "I search related artists to find hidden gems.", value: 'H' },
      { icon: "💿", text: "Hidden B-Sides", subtext: "I prefer album tracks over the main title song.", value: 'H' }
    ]
  }
];
...
export const RECIPES_KO: Record<string, { name: string; description: string; tags: string[] }> = {
  ...
  'BDOH': { name: '매콤한 칠리 스튜', description: '매콤한 스튜처럼 꾸밈없고 직설적인 맛. 답답한 머릿속을 시원하게 비워주는 멈출 수 없는 가사가 특징입니다.', tags: ['힙합', '메시지', '강렬'] },
